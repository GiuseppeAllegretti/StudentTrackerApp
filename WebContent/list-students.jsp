							...
							<tbody>
								<c:forEach var="tempStudent" items="${STUDENT_LIST}">
									...
									<tr>
										...
										<td>
											<a href="${tempLink}" class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
												Modifica 
											</a> | 
											<!-- MODALE per ogni studente -->
											<a href="#" class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" data-bs-toggle="modal" data-bs-target="#modalElimina${tempStudent.id}">
												Elimina 
											</a> 
